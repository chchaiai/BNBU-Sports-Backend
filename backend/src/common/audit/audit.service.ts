...
const FOUNDATION_METADATA_ALLOWLIST = {
  ...
  MEDIA_UPLOAD_INITIATED: new Set(['sessionId', 'mediaType', 'nextStatus']),
  MEDIA_UPLOAD_CONFIRMED: new Set(['sessionId', 'mediaType', 'previousStatus', 'nextStatus']),
  MEDIA_BOUND: new Set(['sessionId', 'mediaType', 'previousStatus', 'nextStatus']),
  ...
  MEDIA_ACCESSED: new Set(['sessionId', 'mediaType', 'purpose']),
