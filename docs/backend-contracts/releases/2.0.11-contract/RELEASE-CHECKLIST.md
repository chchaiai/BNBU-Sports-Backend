# Contract 2.0.11 Post-Merge Release Checklist
...
3. Confirm `docs/backend-contracts/openapi.yaml` still hashes to `c3bdba5999404ea5c58b48407f582ed7b6f19fe955b793f5dfba78303ae9edb1`.
4. Finalize the immutable snapshot at `docs/backend-contracts/contract-history/2.0.11-contract-c3bdba5999404ea5c58b48407f582ed7b6f19fe955b793f5dfba78303ae9edb1/` in a dedicated post-merge release commit.
5. Confirm the current-baseline pointer reports `2.0.11-contract` as `published` only in that release commit.
