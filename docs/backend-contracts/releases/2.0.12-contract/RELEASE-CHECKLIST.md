# Contract 2.0.12 Post-Merge Release Checklist
...
3. Confirm `docs/backend-contracts/openapi.yaml` still hashes to `916461bed7c2fd14f28f0d750b7f414fd12f31db1ade09dc52777208fc3790d6`.
4. Finalize the immutable snapshot at `docs/backend-contracts/contract-history/2.0.12-contract-916461bed7c2fd14f28f0d750b7f414fd12f31db1ade09dc52777208fc3790d6/` in a dedicated post-merge release commit.
5. Confirm the current-baseline pointer reports `2.0.12-contract` as `published` only in that release commit.
