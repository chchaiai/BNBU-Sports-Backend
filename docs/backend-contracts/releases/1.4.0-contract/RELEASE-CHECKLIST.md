...
3. Confirm `docs/backend-contracts/openapi.yaml` still hashes to `d004ccb34b3e2bbf2958a34afba0cb64f820c0a1e610be1581d5ad1b3bf42ca1`.
4. Copy the candidate snapshot into `docs/backend-contracts/contract-history/1.4.0-contract-d004ccb34b3e2bbf2958a34afba0cb64f820c0a1e610be1581d5ad1b3bf42ca1/` with its manifest in a dedicated post-merge release commit.
