# Contract 2.0.2 Post-Merge Release Checklist
...
3. Confirm `docs/backend-contracts/openapi.yaml` still hashes to `853e7f5efadb10dcbbe0f446c4c60962ce2fd864360a156343b5740d0c1761a4`.
4. Finalize the immutable snapshot at `docs/backend-contracts/contract-history/2.0.2-contract-853e7f5efadb10dcbbe0f446c4c60962ce2fd864360a156343b5740d0c1761a4/` in a dedicated post-merge release commit.
5. Confirm the current-baseline pointer reports `2.0.2-contract` as `published` only in that release commit.
