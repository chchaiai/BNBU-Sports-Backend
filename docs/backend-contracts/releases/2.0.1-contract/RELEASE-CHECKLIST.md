# Contract 2.0.1 Post-Merge Release Checklist
...
3. Confirm `docs/backend-contracts/openapi.yaml` still hashes to `061a61f9f542a61878474b7d658e1f07060a0a715f26963d4c6c60421e827141`.
4. Finalize the immutable snapshot at `docs/backend-contracts/contract-history/2.0.1-contract-061a61f9f542a61878474b7d658e1f07060a0a715f26963d4c6c60421e827141/` in a dedicated post-merge release commit.
5. Confirm the current-baseline pointer reports `2.0.1-contract` as `published` only in that release commit.
