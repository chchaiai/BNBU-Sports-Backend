# Contract 2.0.1 Release Changelog

Baseline: immutable `2.0.0-contract` SHA-256 `0e350cecf84a615dea53346ceff0a221de449976ce3d28be4cb84ba6aa3a4dd9`.

- Preserves the published 2.0.0-contract snapshot and advances the API surface under the unique `2.0.1-contract` version.
