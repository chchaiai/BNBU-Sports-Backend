...
| Metric                                 |   Count |
| -------------------------------------- | ------: |
| Contract operations                    |     122 |
| Implemented and conformant             |     104 |
| Intentionally disabled and fail-closed |      18 |
| Not implemented                        |       0 |
| Enabled success coverage               | 104/104 |
| Error/access coverage                  | 122/122 |
...
| updateCurrentUserProfile         | PATCH  | `/me`                                                     | INTENTIONALLY_DISABLED     | INTENTIONALLY_DISABLED_VALIDATED | -              | 401, 503                |
...
| listEnrollments                  | GET    | `/enrollments`                                            | IMPLEMENTED_AND_CONFORMANT | BOTH_VALIDATED                   | 200            | 401, 403                |
...
| initiateMediaUpload              | POST   | `/media-uploads`                                          | IMPLEMENTED_AND_CONFORMANT | BOTH_VALIDATED                   | 201            | 401                     |
...
| getCurrentUserPreferences        | GET    | `/me/preferences`                                         | IMPLEMENTED_AND_CONFORMANT | BOTH_VALIDATED                   | 200            | 401                     |
